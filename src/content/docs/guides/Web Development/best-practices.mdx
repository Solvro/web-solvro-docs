...
## Default i niedefault exporty

W naszej zacnej organizacji aka kole naukowym _umówiliśmy_ się co do jednej **konwencji pisania stron i komponentów**. Default eksporty używamy tylko na stronach typu `page.tsx`:
...
ale jeśli robimy komponenty to zawsze eksportujemy je jako niedefaultowe:
