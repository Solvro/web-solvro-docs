...
<AsciinemaPlayer src={newRepo01} idleTimeLimit={1} cols={140} rows={40} >
...
<AsciinemaPlayer src={newRepo02} idleTimeLimit={1} cols={140} rows={40}>
...
<AsciinemaPlayer src={newRepo03} idleTimeLimit={1} cols={140} rows={40}>
...
<AsciinemaPlayer src={commit01} idleTimeLimit={1} cols={140} rows={40} >
...
<AsciinemaPlayer src={commit02} idleTimeLimit={1} cols={140} rows={40}>
...
<AsciinemaPlayer src={publish01} idleTimeLimit={1} cols={140} rows={40} >
...
<AsciinemaPlayer src={commit03} idleTimeLimit={1} cols={140} rows={40}>

1. Dokonujemy jakieś zmiany w repozytorium
2. Przygotowujemy wybrane zmiany do złożenia
3. Dokonujemy zapisu i opisujemy zmiany, oznaczając Linusa Torvaldsa jako współautora
4. Wysyłamy zmiany do zdalnego repo
5. Sprawdzamy `git log` - widać cały opis zmian
6. Sprawdzamy `git log --oneline` - widać tylko pierwszą linijkę
