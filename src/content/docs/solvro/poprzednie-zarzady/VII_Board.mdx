...
<CardGrid>
  ...
  <Card title="Wiktoria Mróz">
    Przed objęciem funkcji Wiceprezeski VII Zarządu pełniła rolę Przewodniczącej
    Młodzieżowej Rady Miejskiej, a także uzyskała stypendium dla Dziewczyn w STEM.
    Obecnie rozwija się w obszarze Machine Learning. Lubi quizy i teleturniej
    Jeden z Dziesięciu.
  </Card>
...
Każda sfera od struktury organizacyjnej, przez sposoby komunikacji, po prowadzenie projektów i długoterminowy plan strategiczny została przeanalizowana i zrestrukturyzowana.
...
Zadania operacyjne 25Q1 cieszyły się efektywnością przypisaną 60%. Oznacza to, że 60% z zadań, które zostały przypisane do członków danej sekcji zostały ukończone. Sam wynik pozostawia wiele do życzenia, szczególnie w kontekście członków aktywnych, nie mniej jednak zostały wykonane 44 małe kroczki, które dodały wartość dodaną KN Solvro.

Skuteczność przypisana określa aktywizację sekcji i zdolność członków do realizacji zadań. Skuteczność ogólna określa zdolność przewodniczącego sekcji do planowania działań sekcji.

Z podziałem na sekcje wygląda to następująco:

| Sekcja     | Przewodniczący    | Utworzone zadania | Przypisane zadania | Zrobione + In review | Skuteczność przypisana / ogólna |
| ---------- | ----------------- | ----------------- | ------------------ | -------------------- | ------------------------------- |
| UI/UX      | Anna Magierewicz  | 12                | 9                  | 5                    | 55% / 41%                       |
| Backend    | Dawid Linek       | 23                | 23                 | 16                   | 69% / 69%                       |
| Frontend   | Bartosz Gotowski  | 24                | 12                 | 7                    | 58% / 29%                       |
| ML         | Łukasz Lenkiewicz | 6                 | 0                  | 0                    | -% / 0%                         |
| Mobile     | Szymon Kowaliński | 16                | 11                 | 7                    | 63% / 43%                       |
| Promotion  | Jakub Morawiec    | 13                | 10                 | 4                    | 40% / 30%                       |
| Management | Wojtek Krzos      | 16                | 8                  | 5                    | 62% / 31%                       |
| **Suma**   |                   | **110**           | **73**             | **44**               | **60% / 40%**                   |
...
- Utworzenie API ToPWR, które zostało udostępnione np. Samorządowi studenckiemu
...
- Testownik, który umożliwiał dostęp do quizów dot. zakresu danego przedmiotu.
...
Obecnie wśród organizacji studenckich Solvro ma bardzo dobrą opinie, przez co dostajemy coraz to więcej ofert współpracy z coraz to nowszymi kołami.

#### Taktyczny S3.T1: Budowa kultury organizacyjnej

W ramach tego celu został podjęty szereg działań, które końcowo zbudowały zaangażowaną grupę osób w Solvro, które chętnie dzielą się wiedzą i przyczyniają się do rozwoju organizacji. Kilka kluczowych inicjatyw w ramach tego celu zawierało:
...
- Kontynuacja systemu rodzica
- Wsparcie innowacji otwartej #otwarta-komunikacja i open source
- Dynamiczny wzrost aktywności na githubie i discordzie
- Badanie OCAI dot. kultury organizacyjnej
- Szkolenia miękkie z 4S

#### Taktyczny S3.T2: Przekazywanie wiedzy i kompetencji

Za naszej kadencji udało się wprowadzić szereg rozwiązań wspomagających sprawne przekazanie wiedzy i kompetencji, co jest kluczowe do budowania kolejnych pokoleń członków Solvro. Możemy do nich zaliczyć m.in.:

- Restrukturyzacja dysku, maila i githuba
- Sformalizowanie i zinstytucjonowanie sekcji względem przekazywania umiejętności twardych
...
Udało się zbudować popularny obraz KN Solvro, gdzie naszych aplikacji użyło 30K użytkowników oraz osiągnęliśmy 216K wyświetleń na social mediach. Pokazywaliśmy się wszędzie, gdzie tylko się dało, a szczególnie:

- Zrealizowaliśmy materiały promocyjne w tym plakaty, rollupy i wlepy
- 21 postów na naszym blogu
- ~20 razy pojawiliśmy się na stronie Wydziału Informatyki i Telekomunikacji
- 3 razy pojawiliśmy się na stronie Politechniki Wrocławskiej
...
- 3 audycje w radio luz
- 2 transmisje w tv styk
- 1 audycja w echo24
- 1 audycja w radio wrocław
- 1 transmisja TVP3 Wrocław
- Artykuł w gazecie Uniwersytetu Opolskiego
- Pojawiliśmy się na DAS, WAS, DAWIT, Spotkaniu Choinkowym
- Kilka z Solvro Talków było otwartych dla studentów
- Konferencja WITKoN
...
- Złożenie wniosku Unite! Seed Fund i otrzymanie finansowania
- Złożenie wniosku FAST z Wrocławskiego Centrum Akademickiego
- Nawiązaliśmy dobre kontakty z administracją PWR w tym z Wydziałem W4, Działem Informatyzacji, Centrum Współpracy Międzynarodowej, Działem Wsparcia Aktywności Studenckiej i wiele więcej.
- Zostanie Strategicznym Kołem Naukowym Politechniki Wrocławskiej

### Sprawozdanie inicjatyw strategicznych
...
- Po analizie otoczenia zwróciliśmy większą uwagę na sektor "Władze", z którą udało się poprzez ostatni rok zbudować bardzo dobre relacje uczestnicząc w spotkaniach m.in z kierowniczką DWAS, prodziekanem ds. Studenckich Wydziału Informatyki dr hab. inż. Pawłem Wachel, Prezeską Fundacji Manus Anną Bajor-Traczyńską, wicedyrektorem Działu Informatyzacji dr inż. Rafałem Tadaszakiem, z Prorektorem ds. Informatyzacji prof. dr hab. inż. Tomaszem Nowakowskim, spotkanie z Prorektorem ds. Studenckich dr inż. Piotrem Górskim i JM Rektorem prof. dr hab. inż. Arkadiuszem Wójsem
- Rozszerzyliśmy nasz zakres działalności o projekty poza Politechniczne typu Manus, Unite! czy FAST WCA
...
- System celów kwartalnych pozwolił utworzenie grupy członków aktywnych, a jednocześnie rozwój organizacji przez "100 małych kroczków". Skuteczność wynosiła 60%.
...
Wakacyjne wyzwanie miało na celu poprawę sytuacji kadrowej w KN Solvro. Zostały przeprowadzone kilkumiesięczne kursy frontend i backend, gdzie następnie osoby miały możliwość dołączenia do Solvro. Inicjatywa stanowiła 3. rekrutację KN Solvro i odbiła się bardzo pozytywnym echem.
...
We współpracy z TK Games, WRSS W4 została zorganizowana konferencja wydziałowa. Stanowiła ona bardzo pozytywny punkt we współpracy z władzami wydziałowymi. Dodatkowo zapoczątkowało cykliczną serię wydarzeń i w 2025 wydarzenie jest powtarzane.

#### I5. Rozpoczęcie projektu z fizycznym trwałym efektem (hardware)

Utworzenie sekcji hardware przyniosło benefity w postaci drukarki 3d oraz początkowego sprzętu umożliwiającego realizację gadżetów promocyjnych i figurek. Posiadając drukarkę mieliśmy uzasadnienie do otrzymania biura na stałe.
...
Forma rekrutacji została zmieniona na 3 stopniową rekrutację obejmującą wstępny formularz, zadanie rekrutacyjne i opcjonalną rozmowę. Proces został sformalizowany na docs.solvro.pl
...
- 94k wyświetleń na facebooku, 6k zasięgu, 2.6k interakcji
- 8817 wyświetleń na instagramie, 766 zasięgu, 376 interakcji
...
Nasi członkowie pomagali przy organizacji konferencji o klasyfikacji międzynarodowej ML in PL
...
Przy tym punkcie warto wspomnieć o otrzymaniu 2 grantów "Śmigło" w kategorii naukowe na projekty PromoCHATor i LedCube.
...
- 1 audycja w radio wrocław
- 1 transmisja TVP3 Wrocław
- Ukazanie się w gazecie Uniwersytetu Opolskiego
...
- Pozyskano 65k z wniosku strategicznego
...
- Pozyskano barter w postaci jedzenia i picia na wydarzenia wewnętrzne
- Pozyskano 100 koszulek od Ulam Labs
- Pozyskano 6 laptopów MacBook
...
- Mail Zarządowy: 2413 wątki, rekordzista 68 maili w wątku. Prezes 1318 maili na studenckim mailu (znaczna część dotyczyła Koła)
...
- Partnerzy zewnętrzeni: Identt, AWS, Manus, Ulam Labs, JetBrains, SeoHost, FlutterCon, HackYeah, 4Developers, ML in PL, Board of European Students of Technology, Koło Naukowe Chorób Serca UMED, ByteByteGo, Familijna, Redbull, SKNF Bozon AGH, Centralny Ośrodek Informatyki, Deviniti, Bootland, WDI, WAIT AI, Superteam
- Partnerzy wewnętrzni: LEM, Centrum Relacji Międzynarodowych, Dział Dostępności i Wsparcia dla Osób z Niepełnosprawnościami, Biuro Karier, 50 kół naukowych w ToPWR, Pion rektora, Wydział W4, BEST Wrocław, Studium Sportu, WRSS W8 i W4, Samorząd Główny, TK Games, Pracownia Systemów Cyberfizycznych, Radio Luz, Dział Informacji i Promocji, Stowarzyszenie Absolwentów PWR, Strefa Kultury Studenckiej, Dział Informatyzacji, DWAS, Newsletter Studencki, 4S
...
| Fizyczni                                 | Michał Pawłowski                                 | Dawid Linek       | Anulowany                   | 2023 – 2024                      |
| Dziennik Snu                             | Szymon Kowaliński                                | Szymon Kowaliński | W realizacji                | od stycznia 2024                 |
...
| Wakacyjne wyzwanie                       | Dawid Linek, Bartosz Gotowski, Łukasz Lenkiewicz | Szymon Kowaliński | Zakończony                  | lipiec - październik 2024        |
