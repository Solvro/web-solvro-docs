...
Zadania operacyjne 25Q1 cieszyły się efektywnością przypisaną 60%. Oznacza to, że 60% z zadań, które zostały przypisane do członków danej sekcji zostały ukończone. Sam wynik pozostawia wiele do życzenina, szczególnie w kontekście członków aktywnych, nie mniej jednak zostały wykonane 44 małe kroczki, które dodały wartość dodaną KN Solvro.
...
| ML         | Łukasz Lenkiweicz  | 6                 | 0                  | 0                    | -% / 0%                         |
| Mobile     | Szymkon Kowaliński | 16                | 11                 | 7                    | 63% / 43%                       |
| Promotion  | Jakub Morawiec     | 13                | 10                 | 4                    | 40% / 30%                       |
| Management | Wojtek Krzos       | 16                | 8                  | 5                    | 62% / 31%                       |
| **Suma**   |                    | **126**           | **73**             | **44**               | **60% / 35%**                   |
