...
Możesz utworzyć go na stronie githuba (_settings -> developer settigns -> personal access tokens -> tokens (classic)_).
...
Teraz możesz poukładać sobie tę wiedzę, pracując na prawdziwych repozytoriach. Nie przejmuj się, jeśli na początku będziesz popełniać błędy - wszyscy tak zaczynaliśmy.
