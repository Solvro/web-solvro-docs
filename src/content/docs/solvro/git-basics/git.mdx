...
Aby zapisywać gdzieś zmiany w oprogramowaniu, potrzebujemy uwtorzyć **repozytorium** - ukryty folder w naszym projekcie, który zawiera pliki i metadane potrzebne gitowi do poprawnego działania.
...
<img
  ...
  style="margin-left:auto; margin-right:auto"
/>
_Przy większej ilości galęzi, trudno odczytać coś z diagramu historii._
