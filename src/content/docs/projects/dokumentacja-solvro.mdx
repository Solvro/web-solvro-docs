...
5. Otwieramy przeglądarkę na http://localhost:4321
   ...
   ![Terminal po wpisaniu `npm run dev` z linkiem do strony localhost:4321](/src/assets/docs/terminal.png)
...
3. Strona powinna automatycznie się pokazać w pasku nawigacyjnym po lewej
   ...
   ![Zaznaczone na czerwono po lewej w nawigacji "ML Handbook" i strona z samym handbookiem](/src/assets/docs/ml.png)
...
1.  Po wejściu w plik .md w VS Code, kliknijcie w prawym górnym rogu na podgląd:
    ...
    ![Strzałka wskazująca na prawy górny róg edytora z ikonką oznaczającą podgląd](/src/assets/docs/open-preview.png)

2.  Po kliknięciu powinien wam się otworzyć podgląd po prawej stronie:

    ![Podgląd markdowna w vscode](/src/assets/docs/preview-opened.png)
