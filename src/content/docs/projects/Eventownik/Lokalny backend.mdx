...
<Tabs>
  ...
  <TabItem label="v3 (Nest)">
    ...
    Po włączeniu backendu, pod adresem [http://localhost:3333/api/docs](http://localhost:3333/api/docs) znajdzie się automatyczna dokumentacja endpointów ze Swaggera.
  </TabItem>
</Tabs>
