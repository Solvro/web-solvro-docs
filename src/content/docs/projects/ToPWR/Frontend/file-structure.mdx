...
description: Struktura plików w projekcie Solvro/web-topwr.
---
...
This distinction also applies to feature code. For a good example look at the [Polish Language feature](https://github.com/Solvro/web-topwr/tree/main/src/features/polish/).
...
<Aside type="note">
  Not all resources need to have each of these pages. For some resources it
  might not make sense to have a creation page, for example, so this is more of
  a general guideline.
</Aside>
...
The conventions on feature folders is explained more in-depth on [the conventions page](https://docs.solvro.pl/projects/topwr/frontend/conventions#feature-based-architecture)
