...
<br />
Najważniejsze jednak, że dobrze napisane testy dają nam spokój ducha i
sprawiają, że nie musimy obawiać się deployu.
...
- Oferuje wbudowane funkcje:
  - Mocki – czyli “fałszywe” wersje funkcji, klas czy modułów,
    które pozwalają testować fragmenty kodu bez wywoływania
    rzeczywistych zależności.
  - Snapshoty – zapis stanu komponentu lub wyniku funkcji w
    pliku, który potem można porównać w kolejnych testach,
    żeby upewnić się, że nic się nie zmieniło.
  - Tryb watch – automatyczne uruchamianie testów przy każdej
    zmianie w kodzie, dzięki czemu od razu widać efekt zmian.
