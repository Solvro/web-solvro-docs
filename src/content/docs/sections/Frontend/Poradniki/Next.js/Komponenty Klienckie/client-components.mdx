...
Jak widać na prykładzie powyżej, wszytkie komponenty, które muszą być rerenderowane na bierząco, w tym przypadku koszyk i sekcja polecanych, są komponentami klienckimi. Wszystko, co jest statyczne, tutaj opis produktu i navbar, jest generowane na serwerze.
