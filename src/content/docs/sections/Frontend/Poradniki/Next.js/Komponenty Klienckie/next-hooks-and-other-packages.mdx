...
Dzięki useRouter możemy też blokować scrollowanie na stronie, kiedy zmieniamy ścieżkę:
...
<Aside>
  Warto zaznaczyć, że useRouter najczęściej jest wykorzystywany wewnątrz funkcji
  będących event handlerami, ale dla prostoty zrozumienia podałem przykład jak
  można zamienić zwykły przycisk w link.
</Aside>
