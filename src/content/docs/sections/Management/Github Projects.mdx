...
Jedno z pól standardowych, predefiniowanych przez githuba, których nie możemy usunąć. Pod spodem jest ono polem wyboru z zdefiniowanymi statusami. Domyślnie są to Todo, In progess i Done, ale istnieje opcja ich modyfikacji.
